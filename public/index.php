...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>LAMP packaged by Bitnami</title>
  ...
  <body>
    <main class="margin-t-huge">
      <section aria-labelledby="installation-title" aria-describedby="installation-desc" class="container container-tiny margin-b-giant">
        ...
        <p id="installation-desc" class="type-big">You are now running <strong>LAMP packaged by Bitnami</strong>.</p>
      </section>
          ...
          <div class="row row-collapse-b-tablet align-center ">
            ...
            <div class="col-6">
              <ul class="remove-style margin-reset">
                <li class="padding-v-normal"><a href="https://docs.bitnami.com/general/infrastructure/lamp/get-started/get-started/" target="_blank" style="width: 100%;" class="button text-c button-accent">Get Started</a></li>
                <li class="padding-v-normal"><a href="https://docs.bitnami.com/general/infrastructure/lamp/get-started/access-phpmyadmin/" target="_blank" style="width: 100%;" class="button text-c button-primary">Connect to phpMyAdmin</a></li>
                <li class="padding-v-normal"><a href="https://docs.bitnami.com/general/infrastructure/lamp/" target="_blank" style="width: 100%;" class="button text-c button-primary">Documentation</a></li>
                <li class="padding-v-normal"><a href="https://github.com/bitnami/vms" target="_blank" style="width: 100%;" class="button text-c button-primary">Support</a></li>
    ...
    <footer class="text-c">
      ...
      <?php
        echo '<h1 class="text-3xl font-bold text-blue-600 p-4">Hola desde Lightsail!</h1>';
      ?>
